...
class Operaton_DMN_Database
{
     ...
     *
     * @param int|null $form_id Optional specific form ID to clear, or null for all
     * @since 1.0.0
     */
    public function clear_configuration_cache($form_id = null)
    {
        ...
        // ENHANCED: Clear any plugin-specific transients more thoroughly
        global $wpdb;
        ...
        // CRITICAL FIX: Clear assets manager localization cache
