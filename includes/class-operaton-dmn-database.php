...
class Operaton_DMN_Database {
    ...
    public function check_database_health() {
        ...
        $columns = $this->wpdb->get_col("SHOW COLUMNS FROM {$this->table_name}");
        $required_columns = array(
            'id', 'name', 'form_id', 'dmn_endpoint', 'decision_key',
            'field_mappings', 'result_mappings', 'evaluation_step', 'button_text',
            'use_process', 'process_key', 'show_decision_flow', 'created_at', 'updated_at'
        );
