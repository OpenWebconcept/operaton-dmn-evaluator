...
(function() {
    ...
    function initializeWithjQuery($) {
        ...
        function waitForOperatonAjax(callback, maxAttempts = 50) {
            ...
            function check() {
                ...
                if (typeof window.operaton_ajax !== 'undefined') {
                    ...
                    console.error('❌ Available window objects:', Object.keys(window).filter(k => k.includes('operaton')));
        ...
        function bindNavigationEvents(formId) {
            ...
            $form.on('click.operaton-nav-' + formId, '.gform_previous_button, input[value="Previous"], button:contains("Previous")', function() {
